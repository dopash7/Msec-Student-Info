...
<body>
    ...
    <div class="w3-main" style="margin-left:250px;">
        ...
        <div id="myTop" class="w3-container w3-top w3-theme w3-large bluecolor">
            ...
            <div class="w3-container" style="padding:32px">
                <H3 class="w3-xxxlarge" style="font-size: 40px!important;font-weight: bold; color: #464866!important;">PERSONAL DETAILS:</H3>
 ...
 function ExportToExcel(type, fn, dl) {
       ...
       return dl ? XLSX.write(wb, { bookType: type, bookSST: true, type: 'base64' }): XLSX.writeFile(wb, fn || ('PERSONAL_DETAILS.' + (type || 'xlsx')));
    }
</script>
