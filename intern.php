...
<body>
    ...
    <nav class="w3-sidebar w3-bar-block w3-collapse w3-animate-left w3-card bluecolor topnav" style="z-index:3;width:250px;" id="mySidebar">
            ...
            <a class="w3-bar-item w3-button active" href="intern.php?name=<?php echo$_GET['name']; ?>&batch=<?php echo$_GET['batch']; ?>"><i class="fa fa-laptop" aria-hidden="true"></i> Intern</a>
    ...
    <div class="w3-container" style="padding:32px">
     ...
     <H3 class="w3-xxxlarge" style="font-size: 40px!important;font-weight: bold;">INTERNSHIP:</H3>
     ...
     <?php
        ...
        // Attempt select query execution
                ...
                $sql = "SELECT `id`, `rollno`, `name`, `office_name`,`domain`,`duration_intern`,`start_intern`,`end_intern` FROM msec.".$_GET['name'] ;
                ...
                echo '<table  class="table table-bordered table-striped" id="customers">';
                    ...
                    while($row = mysqli_fetch_array($result)){
                        echo "<tr>";
                            ...
                            echo "<td>" . $row['duration_intern'] . "</td>";
                            echo "<td>" . $row['start_intern'] . "</td>";
                            echo "<td>" . $row['end_intern'] . "</td>";
                            echo "<td>";
    ...
    <script>
       ...
       return dl ? XLSX.write(wb, { bookType: type, bookSST: true, type: 'base64' }): XLSX.writeFile(wb, fn || ('INTERN.' + (type || 'xlsx')));
    }
    </script>
