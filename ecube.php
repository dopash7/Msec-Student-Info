...
<body>
    ...
    <nav class="w3-sidebar w3-bar-block w3-collapse w3-animate-left w3-card bluecolor topnav" style="z-index:3;width:250px;" id="mySidebar">
            ...
            <a class="w3-bar-item w3-button active" href="ecube.php?name=<?php echo$_GET['name']; ?>&batch=<?php echo$_GET['batch']; ?>"><i class='fas fa-users'></i> E-Cube</a>
    ...
    <div class="w3-container" style="padding:32px">
     ...
     <?php
        ...
        // Attempt select query execution
                ...
                $sql = "SELECT `id`, `rollno`, `name`, `ecube_topic` FROM msec.".$_GET['name'] ;
    ...
    <script>
       ...
       return dl ? XLSX.write(wb, { bookType: type, bookSST: true, type: 'base64' }): XLSX.writeFile(wb, fn || ('E-CUBE.' + (type || 'xlsx')));
    }
    </script>
